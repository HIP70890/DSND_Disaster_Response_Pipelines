...
def load_data(messages_filepath: str, categories_filepath: str) -> pd.DataFrame:
    ...
    # select the first row of the categories dataframe, to extract the column names
    # while stripping of the number suffix
    ...
    # strip away the attribute name (ie. prefix) from the values
